...
مجلد `beauty/` يحوي متجراً من صفحة واحدة لأدوات التجميل والاكسسوارات النسائية: عرض
المنتجات مع تصفية حسب الفئة، سلة طلب تُحفظ في المتصفّح، وإتمام الطلب برسالة واتساب واحدة
مُفصّلة، إضافة إلى قسم فيديوهات تيك توك وانستقرام. مستقلّ كذلك عن التطبيق ولا يحتاج بناءً
ولا حزماً ولا أي مكتبة خارجية.
...
بيانات المتجر (المنتجات وأسعارها، الفيديوهات، جمل الشريط العلوي) في أعلى وسم `<script>`
داخل `beauty/index.html`، وما لم يُضبط منها يظهر تنبيهاً في أعلى الصفحة بدل رابط معطوب.
الشرح الكامل في [`beauty/README.md`](beauty/README.md).
