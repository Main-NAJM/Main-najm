...
المنتجات، سلة طلب تُحفظ في المتصفّح، وإتمام الطلب برسالة واتساب واحدة مُفصّلة، إضافة إلى
قسم فيديوهات تيك توك وانستقرام. مستقلّ كذلك عن التطبيق ولا يحتاج بناءً ولا حزماً.
...
بيانات المتجر كلّها (رقم الواتساب، روابط الحسابات، المنتجات، الفيديوهات) في أعلى وسم
