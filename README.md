...
الحسابات مربوطة: واتساب ‎+213 696 847 079‎، وانستقرام وتيك توك على `@am_aya_x`.

**المنتجات تُدار من داخل الموقع**: رابط «لوحة الإدارة» في أسفل الصفحة يفتح نموذجاً لإضافة
المنتجات وتعديلها وحذفها، محفوظة في Firestore وتظهر للزبونات فوراً. القراءة عامّة والكتابة
محصورة بحساب صاحبة المتجر في `firestore.rules`. وقبل إضافة أي منتج تظهر بطاقة «قيد
التحضير» بأزرار التواصل بدل شبكة فارغة.

بقية بيانات المتجر (اسم المتجر، الفيديوهات، جمل الشريط العلوي) في أعلى وسم `<script>` داخل
`om-aya/index.html`. الإعداد والشرح الكامل في [`om-aya/README.md`](om-aya/README.md).
