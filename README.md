...
| **الحسابات** | تسجيل برقم الهاتف أو البريد الإلكتروني مع كلمة مرور، واختيار المهنة (نجّار/حدّاد/خيّاط/أخرى، حرفياً كان أو تاجراً). عدّة حسابات على الجهاز الواحد ببيانات منفصلة |
