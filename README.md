...
الحسابات مربوطة: واتساب ‎+213 696 847 079‎، وانستقرام وتيك توك على `@am_aya_x`. أما
**قائمتا المنتجات فارغتان عمداً** (`PRODUCTS` و`PHONE`) — تُملآن بالمنتجات والأسعار
الحقيقية، وفي كلٍّ منهما سطر نموذجي مُعطَّل يُنسخ لكل منتج. وما دامتا فارغتين تظهر بطاقة
«قيد التحضير» بأزرار التواصل بدل الشبكة، ويُخفى تلقائياً ما لا معنى له بلا منتجات.

بقية بيانات المتجر (اسم المتجر، الفيديوهات، جمل الشريط العلوي) في أعلى وسم `<script>` داخل
`om-aya/index.html`. الشرح الكامل في [`om-aya/README.md`](om-aya/README.md).
