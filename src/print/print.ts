...
const buildDocument = (title: string, body: string): string => `<!doctype html>
...
export const printHtml = (title: string, body: string): void => {
...
export const downloadHtml = (title: string, body: string, fileName: string): void => {
