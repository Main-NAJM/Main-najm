 ...
 */
export const seedMarketPrices = (craft, customMaterial) => {
 ...
 */
export const seedCustomProduct = (name, basis, marginPct) => {
...
export const seedProducts = (craft) => {
