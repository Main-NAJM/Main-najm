...
/**
 * يعرض تطبيق حرفة برو من داخل الملف.
 *
 * لِمَ أصل ‎https://herfah.local‎ بدل ‎file:///android_asset‎؟ لأن المتصفّح يعامل
...
public class MainActivity extends Activity {
  ...
  private static final String HOST = "herfah.local";
  ...
  private void applyStatusBar() {
    ...
    getWindow().setStatusBarColor(isNight() ? 0xFF0B1324 : 0xFF0F172A);
  }
